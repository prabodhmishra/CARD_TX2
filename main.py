...
flags.DEFINE_float("d_label_smooth", 0.1, "Smooth factor in D (Def: 0.25)")
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        ...
        #    for test_wav in os.listdir(FLAGS.test_dir):
        #        fm, wav_data = wavfile.read(FLAGS.test_dir+test_wav)
        #        wavname = test_wav
        #        if fm != 16000:
